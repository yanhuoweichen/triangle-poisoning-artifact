...
# TriangleLDP-style runner for RR-output decreasing attack on EdgeOrientDelta.
# Put this script and EdgeOrientDelta_TriangleLDP_RR_DecreaseAttack.cpp under TriangleLDP/cpp/.
#
# Usage:
#   ./run_EdgeOrientDelta_rr_decrease_attack.sh [Dataset] [n|-1] [epsilon_list] [workers] [runs] [noise:0|1] [malicious_ratio_list] [poison_prob] [selection] [owner_mode]
#
# Example:
#   ./run_EdgeOrientDelta_rr_decrease_attack.sh Gplus 10000 1.0 2 5 1 0.05,0.10,0.20 1.0 random reporter
#
...
CPP=EdgeOrientDelta_TriangleLDP_RR_DecreaseAttack.cpp
BIN=EdgeOrientDelta_TriangleLDP_RR_DecreaseAttack
EDGE_FILE=../data/${DATASET}/edges.csv
OUT_FILE=../data/${DATASET}/EdgeOrientDelta_RRAttack_decrease_n${N}_eps${EPS_LIST//,/_}_p${MALICIOUS_RATIOS//,/_}_prob${POISON_PROB}.csv
...
echo "[run] dataset=${DATASET}, n=${N}, eps=${EPS_LIST}, workers=${WORKERS}, runs=${RUNS}, noise=${NOISE}, rr_attack=decrease, ratios=${MALICIOUS_RATIOS}, poison_prob=${POISON_PROB}, selection=${SELECTION}, owner_mode=${OWNER_MODE}"
