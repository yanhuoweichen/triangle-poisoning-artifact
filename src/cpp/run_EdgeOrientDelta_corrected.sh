...
# Compatible with your old command style:
#   ./run_EdgeOrientDelta_corrected.sh Gplus 10000 1.0 4 5 1
# Optional:
#   ./run_EdgeOrientDelta_corrected.sh Gplus 10000 0.5,1.0,2.0 4 5 1 0.5 0.8 8 12
...
SRC=${SRC:-EdgeOrientDelta_TriangleLDP_corrected.cpp}
BIN=${BIN:-EdgeOrientDelta_TriangleLDP_corrected}
EDGE_FILE=${EDGE_FILE:-../data/${DATASET}/edges.csv}
OUT=${OUT:-../data/${DATASET}/EdgeOrientDelta_corrected_results.csv}
...
echo "[run] dataset=$DATASET, n=$N, eps=$EPS_LIST, psi=$PSI, workers=$WORKERS, runs=$RUNS, noise=$NOISE, split=$SPLIT, bias=$BIAS, slack=$SLACK"
